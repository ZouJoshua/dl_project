...
"""
@Author  : Joshua
@Time    : 4/30/20 12:45 PM
@File    : toutiao_news_data_spider.py
@Desc    : 今日头条新闻分类数据抓取
...
def get_data(tup):
    ...
    querystring = {"category": cname, "concern_id": "6215497896830175745", "refer": "1", "count": "20", "max_behot_time": t,
                   "last_refresh_sub_entrance_interval": "1524907088", "loc_mode": "5", "tt_from": "pre_load_more", "cp": "51a5ee4f38c50q1",
                   "plugin_enable": "0", "iid": "31047425023", "device_id": "51425358841", "ac": "wifi", "channel": "tengxun", "aid": "13",
                   "app_name": "news_article", "version_code": "631", "version_name": "6.3.1", "device_platform": "android",
                   ...
                   "ab_client": "a1,c4,e1,f2,g2,f7", "ab_feature": "94563,102749", "abflag": "3", "ssmix": "a", "device_type": "MuMu",
                   "device_brand": "Android", "language": "zh", "os_api": "19", "os_version": "4.4.4", "uuid": "008796762094657",
                   "openudid": "b7215ea70ca32066", "manifest_version_code": "631", "resolution": "1280*720", "dpi": "240",
    ...
    with open('toutiao_news_data.txt', 'a') as fp:
        for item in jj['data']:
            item = item['content']
            item = item.replace('\"', '"')
            # print item
...
def get_routine():
    global g_count
    with open('toutiao_news_data.txt', 'r') as fp:
        ll = fp.readlines()
        g_count = len(ll)
        for l in ll:
            ww = l.split('_!_')
