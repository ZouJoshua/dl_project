...
"""
@Author  : Joshua
@Time    : 5/11/20 2:19 PM
@File    : conll_to_brat.py
@Desc    : 
...
def output_brat(output_filepaths, dataset_brat_folders, stats_graph_folder, overwrite=False):
    ...
    for dataset_type in ['train', 'valid', 'test', 'deploy']:
        ...
        utils.create_folder_if_not_exists(brat_output_folder)
        conll_to_brat(output_filepaths[dataset_type], output_filepaths[dataset_type], dataset_brat_folders[dataset_type], brat_output_folder,
                      overwrite=overwrite)