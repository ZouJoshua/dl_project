...
"""
@Author  : Joshua
@Time    : 4/19/20 7:52 PM
@File    : bert_mul_cnn_model_pt.py
@Desc    : 
...
from model_pytorch.pretrained.modeling import BertForTokenClassification
from model_pytorch.basic_encoder import Encoder
from nlp_tasks.information_extraction.lic2019_ie.basic_model_pt import BasicModule
from nlp_tasks.information_extraction.lic2019_ie.utils_pt import get_entities
