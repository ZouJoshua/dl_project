...
from tf_model.imdb_textcnn_model import TextCNN
from preprocess.preprocess_data_imdb import Config,Dataset
...
def train(config, wordEmbedding, data):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            # 保存模型的一种方式，保存为pb文件
            builder = tf.saved_model.builder.SavedModelBuilder("../data/imdb/model/textCNN/savedModel")
            ...
            for i in range(config.training.epoches):
                ...
                for batchTrain in nextBatch(trainReviews, trainLabels, config.batchSize):
                    ...
                    if currentStep % config.training.checkpointEvery == 0:
                        ...
                        path = saver.save(sess, "../data/imdb/model/textCNN/model/my-model", global_step=currentStep)
...
if __name__ == '__main__':
    ...
    train(config, wordEmbedding, data)
