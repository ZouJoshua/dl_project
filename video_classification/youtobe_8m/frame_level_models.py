...
@Author  : Joshua
@Time    : 19-9-5 上午11:20
@File    : frame_level_models.py
@Desc    : Contains a collection of models which operate on variable-length sequences
"""


import math

import video_classification.youtobe_8m.model_utils as utils
from video_classification.youtobe_8m import models
