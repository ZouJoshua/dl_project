...
@Time    : 19-9-5 上午11:10
@File    : eval_util.py
@Desc    : Provides functions to help with evaluating models.
"""

import video_classification.youtobe_8m.average_precision_calculator as ap_calculator
import video_classification.youtobe_8m.mean_average_precision_calculator as map_calculator
import numpy
