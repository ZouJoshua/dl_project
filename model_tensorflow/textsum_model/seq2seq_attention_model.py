...
"""
@Author  : Joshua
@Time    : 2/26/20 2:18 PM
@File    : seq2seq_attention_model.py
@Desc    : Sequence-to-Sequence with attention model for text summarization
...
import model_tensorflow.textsum_model.seq2seq_lib as seq2seq_lib
...
class Seq2SeqAttentionModel(object):
    ...
    def encode_top_state(self, sess, enc_inputs, enc_len):
        ...
        :param enc_inputs: encoder inputs of shape [batch_size, enc_timesteps]
        :param enc_len: encoder input length of shape [batch_size]
        :return: enc_top_states: The top level encoder states.
