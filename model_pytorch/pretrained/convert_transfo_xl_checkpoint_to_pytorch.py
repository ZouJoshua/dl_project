...
import model_pytorch.pretrained.tokenization_transfo_xl as data_utils
from model_pytorch.pretrained.modeling_transfo_xl import (CONFIG_NAME,
                                                         WEIGHTS_NAME,
                                                         TransfoXLConfig,
                                                         TransfoXLLMHeadModel,
                                                         load_tf_weights_in_transfo_xl)
from model_pytorch.pretrained.tokenization_transfo_xl import (CORPUS_NAME,
                                                             VOCAB_NAME)
