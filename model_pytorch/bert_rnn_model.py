...
"""
@Author  : Joshua
@Time    : 3/19/20 5:21 PM
@File    : bert_rnn_model.py
@Desc    : 
...
class Config(object):
    ...
    def __init__(self, config_file, section=None):
        ...
        self.model_name = config.get("model_name", "bert_rnn_pytorch")       # 模型名称
        ...
        self.rnn_hidden = config.getint("rnn_hidden", 768)
...
class BertRNNModel(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.fc_rnn = nn.Linear(config.rnn_hidden * 2, config.num_labels)
