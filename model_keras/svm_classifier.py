...
log_file = os.path.join(LOG_PATH, 'svm_train_log')
log = Logger('svm_Classifier_log', log2console=False, log2file=True, logfile=log_file).get_logger()
