...
"""
@Author  : Joshua
@Time    : 19-7-17 上午10:13
@File    : bilstm_att_classifier.py
@Desc    : 
"""
...
log_file = os.path.join(LOG_PATH, 'bilstm_attention_train_log')
log = Logger('Bilstm_Attention_Classifier_log', log2console=False, log2file=True, logfile=log_file).get_logger()
